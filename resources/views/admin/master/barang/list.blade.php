                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="">Nama Barang</label>
                                                        <input type="text" value="{{ $d->namabarang }}" class="form-control" name="nama_barang" value="{{ $d->nama_barang }}" placeholder="Nama Barang..." required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Jenis Barang</label>
                                                        <select name="idjenis" class="form-control" required>
                                                            <option value="{{ $d->idjenis }}">{{ $d->nama_jenis }}</option>
                                                            @foreach ($data_jenis as $b)
